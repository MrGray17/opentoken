...
export function shouldBlockGrep(query: string): {
	blocked: boolean;
	suggestion?: string;
} {
...
export function shouldBlockGlob(query: string): {
	blocked: boolean;
	suggestion?: string;
} {
...
export function shouldBlockShellGrep(command: string): {
	blocked: boolean;
	suggestion?: string;
} {
	const grepPatterns = [
